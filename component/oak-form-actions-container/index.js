 ...
 *
 */
let OakFormActionsContainer = class OakFormActionsContainer extends LitElement {
    constructor() {
        super();
...
], OakFormActionsContainer.prototype, "align", void 0);
OakFormActionsContainer = __decorate([
    customElement('oak-form-actions-container')
], OakFormActionsContainer);
export { OakFormActionsContainer };
